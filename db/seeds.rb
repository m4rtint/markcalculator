...
u1 = User.create(provider: "facebook", uid: "10154263241449834", name: "Martin Tsang")

t1 = Term.create(name: "Term 1 - 2016", user_id: u1.id)
...
t2 = Term.create(name: "Term 2 - 2016", user_id: u1.id)
